"""
Django settings for Folp project.
...
SECRET_KEY = 'django-insecure-f(!l!r57&-q876sa2aqq67lw=a61(t89=tb92no587h-%oi!b#'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "Folp", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
